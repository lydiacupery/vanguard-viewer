...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create vanguard-app-bdd9
  fly apps create vanguard-app-bdd9-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app vanguard-app-bdd9
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app vanguard-app-bdd9-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'vanguard-app-bdd9-staging' does not match app name in config file 'vanguard-app-bdd9'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name vanguard-app-bdd9-db
  fly postgres attach --app vanguard-app-bdd9 vanguard-app-bdd9-db

  fly postgres create --name vanguard-app-bdd9-staging-db
  fly postgres attach --app vanguard-app-bdd9-staging vanguard-app-bdd9-staging-db
  ```
